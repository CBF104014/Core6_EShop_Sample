...
namespace Core6_EShop.Repository.Interface
{
    public interface IRepository<T>
    {
        ...
        Task<int> UpdByRankey(T data, IDbConnection conn = null, IDbTransaction tran = null);
        Task<int> DelByRankey(long rankey, IDbConnection conn = null, IDbTransaction tran = null);
    }
}
